import sys
sys.path.append('/home/kristmro/workspace')  # Adjust this path as needed
import numpy as np
from CSAD.fast_adap_embedding.Envionment.GridBoatEnv import GridWaveEnvironment
...
def main():
    ...
    waves = (2.5, 12.5, 90)  # Wave conditions (Hs, Tp, direction in degrees)
    ...
    for step_count in range(max_steps):
        state, reward, done, info = env.step(constant_action)
        if done:
