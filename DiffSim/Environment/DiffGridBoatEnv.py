#!/usr/bin/env python3
"""
DiffGridBoatEnvironment.py

Differentiable Grid Wave Environment for Boat Navigation Simulation.
Replicates the old GridWaveEnvironment, but uses PyTorch-based modules:
- DiffCSAD_6DOF (vessel)
- DiffWaveLoad (wave forcing)
- DiffThrdOrderRefFilter (reference filter)
- DiffUtils (utility functions)
- DiffWaveSpectra (for wave spectrum)
...
class DiffGridBoatEnvironment:
    ...
    vessel : DiffCSAD_6DOF
        Differentiable 6-DOF boat simulator.
    waveload : DiffWaveLoad or None
    ...
    ref_model : DiffThrdOrderRefFilter
    ...
    def __init__(self,
        ...
        if self.render_on and pygame is not None:
            ...
            pygame.display.set_caption("Diff Boat Navigation Simulation")
    ...
    def set_task(self,
        ...
        if self.four_corner_test:
            ...
            self.ref_model = DiffThrdOrderRefFilter(self.dt,
                                                    omega=ref_omega,
